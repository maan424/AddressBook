    ...
    void performAction(string selection)
    {
        ...
        switch (selection.ToUpper())
        {
            case "A":
                    ...
                    if (book.add(firstname,lastname, address, email, telephone))
                    {
            ...
            case "E":
                ...
                if (addr == null)
                {
                    Console.WriteLine("Address for {0} count not be found.", firstname + " " + lastname);
                ...
                else
                {
                    ...
                    Console.WriteLine("Address updated for {0}", firstname + " " + lastname);
